...
| Car wash | Beaver's published block list + Google Places car_wash | HDB carparks with a self-service wash (Beaver, QE) | Free |
...
python enrich/crawl_carwash.py      # Google Places car_wash POIs
